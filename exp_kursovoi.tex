...
\gostSetRomanfont{PT Astra Serif}%
\gostSetSansfont{PT Astra Serif}%
\gostSetMonofont{PT Astra Serif}%
\gostSetMainfont{PT Astra Serif}%
\gostSetStampfont{PT Astra Serif}%
\verbatimfont{\fontspec[Scale=1.0]{PT Astra Serif} \itshape}% % Для замены стиля начертания verbatim и verb
